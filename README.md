...
- Parental and doxorubicin-resistant MCF7 breast cancer cell lines Hi-C data and integration with RNA-seq, ATAC-seq. hg19, 5-10kb resolution. TADs and loops became smaller, compartment switching (16% A-B and 16% B-A) correlate with gene expression changes, TAD boundaries but not loop boundaries are enriched in RNA signal, boundary changes associated with open chromatin changes. CTCF, BORIS, FOXA1, Fos-Jun, AP-1. Long-range interaction changes associated with gene expression, same associations with boundaries overlapping EnhancerAtlas. Most results and pathway enrichments are similar to [ours](https://doi.org/10.1038/s41598-023-32568-7). HiCExplorer tools: hicBuildMatrix, hicQC, hicCorrelate, hicNormalize, hicCorrectMatrix, hicPlotMatrix, hicConvertFormat, hicDetectLoops. deepTools: plotHeatmap, plotProfile. HOMER: PCA, A/B compartments, motif analysis. HiCPeaks for aggregated peak analysis. Data: [GSE205874](https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE205874), [GSE174152](https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE174152). <details>
    <summary>Paper</summary>
    Wang, Xuelong, Jizhou Yan, Zhao Ye, et al. “Reorganization of 3D Chromatin Architecture in Doxorubicin-Resistant Breast Cancer Cells.” Frontiers in Cell and Developmental Biology 10 (August 2022): 974750. https://doi.org/10.3389/fcell.2022.974750.
</details>
